...
import com.example.dessertclicker.model.DesertViewModel
...
private fun DessertClickerApp(
    desserts: DesertUiState, onDessertClicked: () -> Unit
) {
    Scaffold(topBar = {
        ...
        DessertClickerAppBar(
            onShareButtonClicked = {
                shareSoldDessertsInformation(
                    ...
                    dessertsSold = desserts.dessertsSold,
                    revenue = desserts.revenue
                )
            }, modifier = Modifier
                .fillMaxWidth()
        ...
        DessertClickerScreen(
            revenue = desserts.revenue,
            dessertsSold = desserts.dessertsSold,
            dessertImageId = desserts.currentDessertImageId,
...
private fun DessertClickerApp(
    ...
    DessertClickerApp(
        uiState, viewModel::onDessertClicked
    )
}
...
fun MyDessertClickerAppPreview() {
    DessertClickerTheme {
        DessertClickerApp(desserts = DesertUiState(), onDessertClicked = {})
    }
}
